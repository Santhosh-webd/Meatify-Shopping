...
import countrychickendetails from "./CountryChickendetails"
import { Footer } from './Footer'
import redsketch from "./images/redsketchnew.png"
import Swal from 'sweetalert2'

export const CountryChicken = ({ cartdetails, setCartdetails }) => {
  return (
    <div>

      <div className="mainsubproduct">
        <div className="producttile">
          <h1>COUNTRY CHICKEN</h1>
          <span className="conchiredunderline">
            <img src={redsketch} alt="" />
          </span>
        </div>
        <div className="maincardsec">
          {countrychickendetails.map((alldata, index) =>
